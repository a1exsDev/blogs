function _() {
    ...
    e?.addEventListener("click", () => {
        const o = e.getAttribute("aria-expanded") === "true";
        t?.classList.toggle("is-active"),
        e.setAttribute("aria-expanded", o ? "false" : "true"),
        e.setAttribute("aria-label", o ? "Open Menu" : "Close Menu"),
        n?.classList.toggle("display-none")
    }
    )
}
_();
...
function te(e, t) {
    ...
    for (const n of t.querySelectorAll(`[${b}]`)) {
        ...
        r && (r.replaceWith(n),
        r.localName === "astro-island" && re(n) && (n.setAttribute("ssr", ""),
...
async function K(e, t, n, o, r) {
    ...
    async function l(i) {
        ...
        if (i.formData) {
            h.method = "POST";
            const w = i.sourceElement instanceof HTMLFormElement ? i.sourceElement : i.sourceElement instanceof HTMLElement && "form"in i.sourceElement ? i.sourceElement.form : i.sourceElement?.closest("form");
            h.body = w?.attributes.getNamedItem("enctype")?.value === "application/x-www-form-urlencoded" ? new URLSearchParams(i.formData) : i.formData
        }
...
async function F(e, t) {
    await K("forward", E, new URL(e,location.href), t ?? {})
}
function Te(e) {
    if (!I() && e.state) {
        location.reload();
...
(D || Pe() !== "none") && (document.addEventListener("click", e => {
    let t = e.target;
    ...
    Y(t) || t.hasAttribute("download") || !t.href || n && n !== "_self" || r !== location.origin || e.button !== 0 || e.metaKey || e.ctrlKey || e.altKey || e.shiftKey || e.defaultPrevented || (e.preventDefault(),
    F(o, {
...
document.addEventListener("submit", e => {
    let t = e.target;
    if (t.tagName !== "FORM" || e.defaultPrevented || Y(t))
        return;
    const n = t
      , o = e.submitter
      , r = new FormData(n,o)
